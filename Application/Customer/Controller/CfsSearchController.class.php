...
class CfsSearchController extends CommonController
{
	...
	public function real_time()
	{
		...
		$id = $_SESSION['id'];
		$where="i.examine='N' and i.entrust_company=$id";
		if(I('get.ship_name'))
		{
	...
	public function complete()
	{
		...
		$id = $_SESSION['id'];
		$where1 = "i.entrust_company=$id and i.examine='Y'";
		if(I('get.ship_name'))
		{
			$ship_name=I('get.ship_name');
		...
		if( I ('get.billno') )
		{
			$billno=I('get.billno');
			$billno = str_replace("'", "", $billno);
			$where1.=" and p.content like '".'%"blno":"'. $billno .'%\'';
		}
	...
	public function documentByCtn()
	{
		...
		$id = $_SESSION['id'];
		$where = "i.entrust_company=$id and i.examine='Y'";
		if(I('get.ship_name'))
		{
			$ship_name=I('get.ship_name');
