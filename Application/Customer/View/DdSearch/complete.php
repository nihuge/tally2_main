				...
				<div style="min-height: 80px;width: 1176px; margin: 0 auto;">
					<div class="searchabc">
						...
						<ul style="margin-left:-32px;">
							...
							<li ><a href="__MODULE__/DdSearch/complete" style="background:#3398db;color:#fff;">完成作业查询</a></li>
			...
			<div class="right_list2">
				<div class="addrule">
					...
					<input type="hidden" name="a" value="complete">
						船&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名： <input type="text" class="input1" name="ship_name" id="shipname" autocomplete="off" style="text-transform: uppercase;"/> &nbsp;&nbsp;&nbsp;&nbsp;
						...
						提&nbsp;&nbsp;单&nbsp;&nbsp;号： <input type="text" name="bl_no" class="input1"><br><br>
