			...
			<div class="right_list2">
				<div class="addrule">
					...
					<input type="hidden" name="a" value="documentByCtn">
						...
						航&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;次： <input type="text" name="vargo" class="input1"> &nbsp;&nbsp;&nbsp;&nbsp;
						...
						集装箱号：<input type="text" name="ctn_no" class="input1"><br><br> 
							...
							<table width="100%" class="table" style="text-align:center;">
								...
								<tbody>
									...
									<tr>
										...
										<td>{$l['createtime']}</td>
										<td>
										  <a href="__CONTROLLER__/documentByCtnMsg/id/{$l['ctn_id']}">查看</a>
										</td>
									</tr>
									</volist>
								</tbody>
