				...
				<div style="min-height: 80px;width: 1176px; margin: 0 auto;">
					<div class="searchabc">
						...
						<ul style="margin-left:-32px;">
							<li ><a href="__MODULE__/CfsSearch/real_time" style="background:#3398db;color:#fff;">实时作业查询</a></li>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td>{$l['newtime']}</td>
									<td>
									   <if condition="$l['status'] eq 0">未开工<else/>工作中</if>
									</td>
								</tr>
								</volist>
							</tbody>
