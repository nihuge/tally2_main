					...
					箱号：{$msg['ctnno']}
						...
						if(in_array('1',$photoauth)){
							...
							if($n>0)
							{
								...
								for($i=0;$i<$n;$i++)
								{
									echo '<a layer-href=".'.$IMAGE_QBZX_EMPTY.$emptylist[$i]['empty_picture'].'" class="" rel="gallery">';
									if ($i == 0) {
									...
									if(count($levellist) < 3){
										if($a || $b){
											if($n > 0){
												echo '（';
												for($j = 0; $j < $n; $j ++) {
													echo '<a layer-href=".'.$l ['cargo_picture'] [$j] ['cargo_picture'].'" class="" rel="gallery' . $l ['level_num'] . '">';
													if ($j == 0) {
									...
									if(count($levellist) < 3){
										if($a || $b){
											if ($n > 0) {
												echo '（';
												for($j = 0; $j < $n; $j ++) {
													echo '<a layer-href=".'.$l ['damage_picture'] [$j] ['damage_picture'].'" class="" rel="gallery' . $l ['level_num'] . '" pid="'.$l['level_num'].'">';
													if ($j == 0) {
