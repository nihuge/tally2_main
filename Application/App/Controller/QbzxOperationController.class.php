...
// 			$list = array_merge_recursive ( $list2, $list3 );
            ...
            if ($res_c ['operator_id']) {
                ...
                if ($res_m !== false) {
                    ...
                    if ($wxinfo[0]['wx_openid'] != "") {
                        $wx_msg_data = array();
                        $wx_msg_data['entrustno'] = $wxinfo[0]['entrustno'];
                        $wx_msg_data['customer_name'] = $wxinfo[0]['customer_name'];
    ...
    {
        if (I('post.ctn_id') and I('post.uid') and is_array(I('post.empty_picture')) and I('post.empty_weight') != null) {
            $ctn_id = I('post.ctn_id');
            $uid = I('post.uid');
            if (I('post.empty_weight') != null) {
    ...
    {
// 		sleep(10);
        if (I('post.level_num') and I('post.operation_id') and I('post.billno') and I('post.cargo_number') !== '') {
