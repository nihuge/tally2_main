...
class BaseController extends Controller 
{
	...
	protected function _initialize()
	{
		...
		$not_check = array (
				'Index/index','User/personal','User/logout','User/pwdup','User/editpwd','User/savepwd','User/login','Search/index','Search/optionsearch','Search/zongliang','Search/didian','Search/kehu','Search/ajaxshua','Search/shishi'// 个人信息，退出登录，修改密码
		);
