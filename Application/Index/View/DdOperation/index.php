			...
			<div class="right_t">
				<div class="amsg">
					<p>
						...
						if($msg['door_picture']!='')
						{
							echo '<span><a layer-href=".'.IMAGE_DD_DOOR.$msg['door_picture'].'" class=""><span class="showphoto">查看箱门照片</span></a></span>';
						}else {
							echo '暂无';
						}
						?>&nbsp;&nbsp;&nbsp;
						...
						if($msg['seal_picture']!='')
						{
							echo '<span><a layer-href=".'.IMAGE_DD_SEAL.$msg['seal_picture'].'" class=""><span class="showphoto">查看铅封照片</span></a></span>';
						}else {
							echo '暂无';
						}
						?>&nbsp;&nbsp;&nbsp;
						箱残损照片：<?php
							...
							if ($n > 0)
                            {
                            	...
                            	for($i = 0; $i < $n; $i ++)
                                {
                                	echo '<span><a layer-href=".'.IMAGE_DD_DAMAGE. $msg['ctn_damage_img'] [$i] ['img'].'" class="" rel="ctn_damage_img"><span class="showphoto">';
                                	if ($i == 0)
                                    {
                                    	echo '查看残损照片';
                                    }
					...
					<p>
					   <?php
						...
						{
							echo '<span><a layer-href=".'.IMAGE_DD_CARGO.$msg['cargo_picture'].'" class=""><span class="showphoto">查看整体货物照片</span></a></span>';
						}else {
							echo '暂无';
						}
						?>&nbsp;&nbsp;&nbsp;
						...
						{
							echo '<span><a layer-href=".'.IMAGE_DD_EMPTY.$msg['empty_picture'].'" class=""><span class="showphoto">查看空箱照片</span></a></span>';
						}else {
							echo '暂无';
						}
						?>
					...
					作业中造成的箱残损照片：<?php
							...
							if ($n > 0)
                            {
                            	...
                            	for($i = 0; $i < $n; $i ++)
                                {
                                	echo '<span><a layer-href=".'.IMAGE_DD_DAMAGEAFTER. $msg['ctn_damage_after_img'] [$i] ['img'].'" class="" rel="ctn_damage_after_img"><span class="showphoto"></span>';
                                	if ($i == 0)
                                    {
                                    	echo '查看箱残损照片';
                                    }
