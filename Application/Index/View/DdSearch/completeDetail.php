					...
					<p>箱号：{$msg['ctn_no']}
						...
						作业中造成的箱残损照片：<?php
							...
							if ($n > 0)
                            {
                            	...
                            	for($i = 0; $i < $n; $i ++)
                                {
                                	echo '<span><a layer-href=".'.IMAGE_DD_DAMAGEAFTER. $operationMsg['ctn_damage_after_img'] [$i] ['img'].'" class="" rel="ctn_damage_after_img"><span class="showphoto">';
                                	if ($i == 0)
                                    {
                                    	echo '查看箱残损照片';
                                    }
							...
							<tbody>
								...
								<tr>
									...
									if (strpos ( $vo ['field_old_value'], '/AppUpload' )) {
										echo '<span><a layer-href="' . $vo ['field_old_value'] . '" class=""><span class="showphoto">查看原照片</span></a></span>';
									} else {
									...
									if (strpos ( $vo ['field_new_value'], '/AppUpload' )) {
										echo '<span><a layer-href="' . $vo ['field_new_value'] . '" class=""><span class="showphoto">查看新照片</span></a></span>';
									} else {
