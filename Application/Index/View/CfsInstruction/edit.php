						...
						<tr style="text-align: right;">
							<td colspan="6">
								...
								<if condition="$msg['examine'] != 'Y'">
									...
									<a onclick="return confirm('你确认要审核通过该指令信息吗？');" href="__CONTROLLER__/examine/instruction_id/{$msg['id']}" style="background-color: #f1691e; border-color: rgb(213, 213, 213); color: rgb(255, 255, 255); font-size: 16px; text-align: center; padding: 3px 15px;">通过</a>
								</if>
							</td>
									...
									<?php $n++;?>
										...
										<td>
										   <if condition="$cl['status'] eq 0"> 
										    ...
										    if($cl['status']=='0'  or $cl['status'] == '-1' and $msg['examine'] != 'Y') 
										    {
