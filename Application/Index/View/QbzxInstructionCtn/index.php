							...
							<table class="table" style="margin: 0 auto; text-align: center;">
								...
								<tbody>
									<tr>
										...
										<td>
										<?php
										if ($msg['status']!='0' and $msg['status']!='-1' and $msg['status']!='2')
										{
								...
								<?php $n=0;?>
									...
									<?php $n++;?>
										...
										<td>
										    ...
										    if($cl['operation_examine']!='2')
										    {
										    	echo '<a class="box" href="__CONTROLLER__/edit/id/'.$cl['id'].'">查看 | 修改</a>| <a onclick="return confirm(\'删除是不可恢复的，你确认要删除吗？\');" href="__CONTROLLER__/del/id/'.$cl['id'].'">删除</a> &nbsp;  <a href="__MODULE__/QbzxOperation/index/ctn_id/'.$cl['id'].'">查看作业详情</a>';
										    }else {
										    	if($cl['status'] == '-1'){ 
