	...
	<div id="wapper">
		<div class="right">
			...
			<div class="right_list2">
				<a id="add" href="__MODULE__/DdPlan/add" style="float: right; margin: -4px 10px 6px;">新增预报计划 </a>
				<a id="reload" class="box" href="__MODULE__/DdPlan/reloadPage" style="float: right; margin: -4px 10px 6px;">查询龙潭cfs拆箱</a>
