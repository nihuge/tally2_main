		...
		<form action="__ACTION__" method="post">
			...
			<table>
				<tr>
					...
					<td><input type="text" class="article" style="width:180px;" name="CTNNO" />
					</td>
				</tr>
				<tr>
					...
					<select name="CTNSIZE" class="article" style="width:180px;">
						<volist name="ctn_size" id="vo">
							<option value="{$vo['ctn_size']}" >{$vo['ctn_size']}</option>
						</volist>
					</select>
					</td>
				</tr>
				<tr>
					...
					<td>
					<select name="CTNTYPE" class="article" style="width:180px;">
						<volist name="ctn_type" id="vo">
							<option value="{$vo['ctn_type']}" >{$vo['ctn_type']}</option>
						</volist>
					</select>
					</td>
				</tr>
