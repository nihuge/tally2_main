		...
		<form action="__ACTION__" method="post">
			...
			<table>
				...
				<tr>
					...
					<td>
					<select name="CTNSIZE" class="article" style="width:180px;">
						<volist name="ctn_size" id="vo">
							<option value="{$vo['ctn_size']}" <?php echo $msg['ctnsize']=== $vo['ctn_size'] ? 'selected' : '';?>>{$vo['ctn_size']}</option>
						</volist>
					</select>
					</td>
				</tr>
				<tr>
					...
					<td><select name="CTNTYPE" class="article" style="width:180px;">
						<volist name="ctn_type" id="vo">
							<option value="{$vo['ctn_type']}" <?php echo $msg['ctntype']=== $vo['ctn_type'] ? 'selected' : '';?>>{$vo['ctn_type']}</option>
						</volist>
					</select>
					</td>
				</tr>
