        ...
        <div class="right_t">
            <div class="amsg">
                <p>
                    ...
                    if ($n > 0) {
                        echo '（';
                        for ($i = 0; $i < $n; $i++) {
                            echo '<a layer-href=".' . $msg ['empty_picture'] [$i] ['empty_picture_a'] . '" layer-pid="111" class="" rel="kongxiang">';
                            if ($i == 0) {
                                echo '<span class="showphoto">查看空箱照片</span>';
                            }
                            echo '</a>';
                        }
                        echo '）';
                    ...
                    <?php
                    if ($msg ['seal_picture']) {
                        echo '<span>（<a layer-href=".' . IMAGE_QBZX_SEAL . $msg ['seal_picture'] . '" class=""><span class="showphoto">查看铅封照片</span></a>）</span>';
                    }
                    ?>
                    <?php
                    if ($msg ['halfclose_door_picture']) {
                        echo '<span>（<a layer-href=".' . IMAGE_QBZX_HALFCLOSEDOOR . $msg ['halfclose_door_picture'] . '" class=""><span class="showphoto">查看半关门照片</span></a>）</span>';
                    }
                    ?>
                    <?php
                    if ($msg ['close_door_picture']) {
                        echo '<span>（<a layer-href=".' . IMAGE_QBZX_CLOSEDOOR . $msg ['close_door_picture'] . '" class=""><span class="showphoto">查看全关门照片</span></a>）</span>';
                    }
                    ?>
                </p>
                <p>
                    ...
                    <a href="__CONTROLLER__/editCtn/operation_id/{$msg['id']}"
                                ...
                                <tr>
                                    ...
                                    <td>{$l['damage_num']}
                                        ...
                                        if ($n > 0) {
                                            echo '（';
                                            for ($i = 0; $i < $n; $i++) {
                                                echo '<a layer-href=".' . $l ['damage_picture'] [$i] ['damage_picture'] . '" class="" rel="gallery' . $l ['level_num'] . '"><span class="showphoto">';
                                                if ($i == 0) {
                                                    echo '查看残损照片';
                                                }
                                                echo '</span></a>';
                                    ...
                                    <td>
                                        ...
                                        if ($n > 0) {
                                            for ($i = 0; $i < $n; $i++) {
                                                echo '<span><a layer-href=".' . $l ['cargo_picture'] [$i] ['cargo_picture'] . '" class="" rel="gallery' . $l ['level_num'] . '"><span class="showphoto">';
                                                if ($i == 0) {
                                                    echo '查看照片';
                                                }
                                                echo '</span></a></span>';
            ...
            <if condition="($ctnMsg['status'] eq 2) and ($msg['operation_examine'] neq 2)">
                <div style="margin-left:700px;font-size:15px;width:300px;height:50px;line-height:50px;">
                    ...
                    <a onclick="return confirm('你确认要审核通过该作业信息吗？');"
                       href="__CONTROLLER__/operation_examine/operation_id/{$msg['id']}/ctn_id/{$ctn_id}/operation_examine/2/instruction_id/{$ctnMsg['instruction_id']}"
                       style="background-color: #f1691e; border-color: rgb(213, 213, 213); color: rgb(255, 255, 255); font-size: 16px; text-align: center; padding: 3px 15px;">通过</a>
                    &nbsp;&nbsp;
                </div>
            </if>
