				...
				<div class="amsg">
					<p>
						...
						if ($n > 0) {
							echo '（';
							for($i = 0; $i < $n; $i ++) {
								echo '<span><a layer-href=".'  . $msg ['empty_picture'] [$i] ['empty_picture_a'] . '" class="" rel="kongxiang">';
								if ($i == 0) {
									...
									<tr>
										...
										<td>{$l['damage_num']}
												...
												if ($n > 0) {
													echo '（';
													for($i = 0; $i < $n; $i ++) {
														echo '<span><a layer-href=".' . $l ['damage_picture'] [$i] ['damage_picture'] . '" class="" rel="gallery' . $l ['level_num'] . '"><span class="showphoto">';
														if ($i == 0) {
															echo '查看残损照片';
														}
														echo '</span></a></span>';
