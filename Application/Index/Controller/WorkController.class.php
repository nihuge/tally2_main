...
// 		$sql1="select * from (select * from __PREFIX__shift order by shift_id desc) a group by department_id ";
// 		$res1=M()->query($sql1);
// 		$count=count($res1);
// 		$per = 15;
// 		if($_GET['p'])
...
// 		$this->assign('page',$show);
		...
		//列表
// 		$begin=($p-1)*$per;
		$sql="select * from (select * from __PREFIX__shift order by shift_id desc) a group by department_id";
		$list=M()->query($sql);
