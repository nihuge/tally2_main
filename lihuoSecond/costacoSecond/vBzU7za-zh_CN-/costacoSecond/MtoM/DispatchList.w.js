...
var __parent0=require('$model/UI2/costacoSecond/MtoM/DispatchList'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='cumqmY3';
	this._flag_='babeb60b8625a496babd447e6c8bfde9';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":false,"autoNew":false,"confirmDelete":true,"confirmRefresh":false,"defCols":{"date":{"define":"date","label":"指令日期：","name":"date","relation":"date","type":"String"},"id":{"define":"id","label":"指令id","name":"id","relation":"id","type":"String"},"numbersofpackages":{"define":"numbersofpackages","label":"件　　数：","name":"numbersofpackages","relation":"numbersofpackages","type":"String"},"operating_type":{"define":"operating_type","label":"拆箱方式：","name":"operating_type","relation":"operating_type","type":"String"},"operating_type_zh":{"define":"operating_type_zh","name":"operating_type_zh","relation":"operating_type_zh","type":"String"},"unpackagingplace":{"define":"unpackagingplace","label":"作业场地：","name":"unpackagingplace","relation":"unpackagingplace","type":"String"},"voyage":{"define":"voyage","label":"航　　次：","name":"voyage","relation":"voyage","type":"String"},"vslname":{"define":"vslname","label":"船　　名：","name":"vslname","relation":"vslname","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"notaskDateCustomRefresh"},"idColumn":"id","limit":5,"xid":"notaskDate"});
 new __Data__(this,{"autoLoad":false,"autoNew":true,"confirmDelete":true,"confirmRefresh":false,"defCols":{"date":{"define":"date","label":"指令日期：","name":"date","relation":"date","type":"String"},"dispatch_id":{"define":"dispatch_id","label":"派工ID","name":"dispatch_id","relation":"dispatch_id","type":"String"},"id":{"define":"id","label":"指令id","name":"id","relation":"id","type":"String"},"numbersofpackages":{"define":"numbersofpackages","label":"件　　数：","name":"numbersofpackages","relation":"numbersofpackages","type":"String"},"operating_type":{"define":"operating_type","label":"拆箱方式：","name":"operating_type","relation":"operating_type","type":"String"},"operating_type_zh":{"define":"operating_type_zh","name":"operating_type_zh","relation":"operating_type_zh","type":"String"},"unpackagingplace":{"define":"unpackagingplace","label":"作业场地：","name":"unpackagingplace","relation":"unpackagingplace","type":"String"},"voyage":{"define":"voyage","label":"航　　次：","name":"voyage","relation":"voyage","type":"String"},"vslname":{"define":"vslname","label":"船　　名：","name":"vslname","relation":"vslname","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"orderDataCustomRefresh"},"idColumn":"id","limit":5,"xid":"orderData"});
}}); 
return __result;});
