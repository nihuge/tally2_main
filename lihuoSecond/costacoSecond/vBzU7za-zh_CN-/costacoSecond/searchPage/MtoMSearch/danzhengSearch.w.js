...
var __parent0=require('$model/UI2/costacoSecond/searchPage/MtoMSearch/danzhengSearch'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='ceUfYFz';
	this._flag_='b796df0848e1b8c12cdfd7da38d689ed';
	this.callParent(contextUrl);
 require('css!$UI/costaco/ajax/jquery-ui.min').load();
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","name":"id","relation":"id","type":"String"},"ship_name":{"define":"ship_name","label":"船名：","name":"ship_name","relation":"ship_name","type":"String"},"shipcode":{"define":"shipcode","label":"船值","name":"shipcode","relation":"shipcode","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"shipInfoCustomRefresh"},"idColumn":"shipcode","limit":20,"xid":"shipInfo"});
 new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"ctn_no":{"define":"ctn_no","label":"箱号：","name":"ctn_no","relation":"ctn_no","type":"String"},"id":{"define":"id","label":"单证ID","name":"id","relation":"id","type":"String"},"ship":{"define":"ship","label":"船名：","name":"ship","relation":"ship","type":"String"},"ship_name":{"define":"ship_name","name":"ship_name","relation":"ship_name","type":"String"},"vargo":{"define":"vargo","label":"航次：","name":"vargo","relation":"vargo","type":"String"}},"directDelete":false,"events":{},"idColumn":"ctn_no","limit":20,"xid":"danzhengList"});
