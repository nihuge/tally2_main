define(function(require) {
	...
	Model.prototype.locationCustomRefresh = function(event) {
		...
		$.ajax({
			...
			// interface_url+"?c=Location&a=getLocationList"
	...
	Model.prototype.searchClick = function(event) {
		...
		$.ajax({
			...
			"data" : {
				/*
				 * "shipname": "voyage" "locationno" "entrustdept" "entrusttime"
				 */
				"vslname" : ship,
				"voyage" : voyage,
				"unpackagingplace" : locationno,
				"date" : ordertime,
				"status" : status
			},
			"dataType" : "json",
			// http://192.168.1.91/xztally/app.php/select/qbzxins
			"url" : interface_url + "?c=DdSearch&a=instruction",
			"success" : function(data) {
	...
	Model.prototype.li1Click = function(event) {
		...
		justep.Shell.showPage("InstructionDetails_dd");
	};
