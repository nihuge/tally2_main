...
var __parent0=require('$model/UI2/costacoSecond/searchPage/cfsSearch/danzhengSearch'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='c6FrmQb';
	this._flag_='6b6a9dd724f6efdb9096979d19c30966';
	this.callParent(contextUrl);
 require('css!$UI/costaco/ajax/jquery-ui.min').load();
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"shipcode":{"define":"shipcode","label":"船值","name":"shipcode","relation":"shipcode","type":"String"},"shipinfoid":{"define":"shipinfoid","name":"shipinfoid","relation":"shipinfoid","type":"String"},"shipname":{"define":"shipname","label":"船名：","name":"shipname","relation":"shipname","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"shipInfoCustomRefresh"},"idColumn":"shipcode","limit":20,"xid":"shipInfo"});
 new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"ctnno":{"define":"ctnno","label":"箱号：","name":"ctnno","relation":"ctnno","type":"String"},"id":{"define":"id","label":"单证ID","name":"id","relation":"id","type":"String"},"ship_name":{"define":"ship_name","label":"船名：","name":"ship_name","relation":"ship_name","type":"String"},"shipname":{"define":"shipname","name":"shipname","relation":"shipname","type":"String"},"voyage":{"define":"voyage","label":"航次：","name":"voyage","relation":"voyage","type":"String"}},"directDelete":false,"events":{},"idColumn":"ctnno","limit":20,"xid":"danzhengList"});
