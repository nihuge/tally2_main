...
var __parent0=require('$model/UI2/costacoSecond/CFS/forecastQF'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='cm6zQ7v';
	this._flag_='7e26be24810a4a7452be4bcdf4bb9ac4';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":false,"defCols":{"isdone":{"define":"isdone","label":"是否铅封：","name":"isdone","relation":"isdone","type":"String"}},"directDelete":false,"events":{},"idColumn":"isdone","initData":"[{\"isdone\":\"1\"}]","limit":20,"xid":"isgoodsbad"});
