define(function(require) {
	...
	Model.prototype.onedoorImgClick = function(event) {
		...
		if (me.array_one.length < 1) {
			function onSuccess(imageURI) {
				...
				localStorage.setItem("ceng_div_id", "show33");
	...
	Model.prototype.submitbtn = function(event) {
		...
		CFS_halfcloseDooSet(ctndetails_ID, onDoor, "3");
	...
	Model.prototype.messageDialogYes = function(event) {
		insert_status(localStorage.getItem('ctndetails_ID'), "3");
	...
	function reflasArray(me) {
		$('#images33_1').empty();
		// 显示小照片的层div
		localStorage.setItem("image_one_id", "images33_1");
