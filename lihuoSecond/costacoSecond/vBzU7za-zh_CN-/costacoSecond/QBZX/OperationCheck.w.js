...
var __parent0=require('$model/UI2/costacoSecond/QBZX/OperationCheck'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='czyuINb';
	this._flag_='89a76adbb085b6226ac9ec2af3be72e4';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"business":{"define":"business","label":"系统名称","name":"business","relation":"business","type":"String"},"emptyweight":{"define":"emptyweight","label":"空箱重量：","name":"emptyweight","relation":"emptyweight","rules":{"number":true},"type":"Float"},"imgBase64":{"define":"imgBase64","label":"空箱照片：","name":"imgBase64","relation":"imgBase64","rules":{"readonly":"true"},"type":"String"},"load":{"define":"load","label":"箱子载重：","name":"load","relation":"load","rules":{"integer":true},"type":"Integer"},"qiid":{"define":"qiid","label":"指令id","name":"qiid","relation":"qiid","type":"String"}},"directDelete":false,"events":{},"idColumn":"qiid","initData":"[{\"business\":\"qbzx\",\"imgBase64\":\"\",\"emptyweight\":{\"value\":\"\"},\"ServiceTeam\":\"1\"}]","limit":20,"xid":"dispatchingOrderDetailsData"});
 new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","label":"劳务队ID","name":"id","relation":"id","type":"String"},"labor_name":{"define":"labor_name","label":"劳务队名称","name":"labor_name","relation":"labor_name","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"laborServiceTeamCustomRefresh"},"idColumn":"id","initData":"[]","limit":20,"xid":"laborServiceTeam"});
}}); 
return __result;});
