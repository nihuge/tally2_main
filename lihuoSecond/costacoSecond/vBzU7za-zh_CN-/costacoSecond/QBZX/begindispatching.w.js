...
var __parent0=require('$model/UI2/costacoSecond/QBZX/begindispatching'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='cyauqaq';
	this._flag_='c2182650e3e5c795bec8cb4119b313b7';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"is_check":{"define":"is_check","label":"是否已派","name":"is_check","relation":"is_check","type":"String"},"signid":{"define":"signid","label":"signid","name":"signid","relation":"signid","type":"String"},"uid":{"define":"uid","label":"userinfoid","name":"uid","relation":"uid","type":"String"},"user_name":{"define":"user_name","label":"姓名","name":"user_name","relation":"user_name","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"staffDataCustomRefresh"},"idColumn":"uid","initData":"[{\"is_must\":\"0\",\"uid\":\"\"}]","limit":5,"xid":"staffData"});
}}); 
return __result;});
