...
var __parent0=require('$model/UI2/costacoSecond/QBZX/index_employees'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='cZjqM73';
	this._flag_='1208cc5054a727f79a6617a9cc9a46fb';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"bm":{"define":"bm","label":"部门","name":"bm","relation":"bm","type":"String"},"day":{"define":"day","label":"班次","name":"day","relation":"day","type":"String"},"gb":{"define":"gb","label":"工班","name":"gb","relation":"gb","type":"String"},"name":{"define":"name","label":"名字","name":"name","relation":"name","type":"String"},"position":{"define":"position","label":"身份","name":"position","relation":"position","rules":{"integer":true},"type":"Integer"},"staffno":{"define":"staffno","label":"工号","name":"staffno","relation":"staffno","type":"String"},"time":{"define":"time","label":"时间","name":"time","relation":"time","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"infoCustomRefresh"},"idColumn":"name","initData":"[{}]","limit":20,"xid":"info"});
}}); 
return __result;});
