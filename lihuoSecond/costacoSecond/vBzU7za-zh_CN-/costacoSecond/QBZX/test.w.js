...
var __parent0=require('$model/UI2/costacoSecond/QBZX/test'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='cBRJFVb';
	this._flag_='16ccb7a0ebeaf326bd2ab5aae75d97fb';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"Time":{"define":"Time","label":"时间","name":"Time","relation":"Time","rules":{"time":true},"type":"Time"},"fDecription":{"define":"fDecription","label":"描述","name":"fDecription","relation":"fDecription","type":"String"},"fImage":{"define":"fImage","label":"图片","name":"fImage","relation":"fImage","type":"String"},"fName":{"define":"fName","label":"品名","name":"fName","relation":"fName","type":"String"}},"directDelete":false,"events":{"onCreate":"data1Create","onCustomRefresh":"data1CustomRefresh","onCustomSave":"data1CustomSave"},"idColumn":"fName","limit":20,"xid":"data1"});
}}); 
return __result;});
