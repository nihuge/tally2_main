...
class DataController extends Controller{
    ...
    */
    public function updcfscargoimg(){
        ...
        // var_dump($data);
        $this->tally->db(1,"mysql://tally_user:njtally2016@localhost:3306/tally2_data")->table('tally_cfs_level_cargo_img')->where("1")->delete();
        ...
        $this->tally->db(1,"mysql://tally_user:njtally2016@localhost:3306/tally2_data")->table('tally_cfs_level_cargo_img')->addAll($array);
    }
    ...
    */
    public function qblevel($res)
    {
        ...
        foreach ($res as $k => $v) {
            ...
            $res = $this->tally->table('tally_qbzx_operation_level')->data($data)->add();
   	...
   	*/
   	public function cus($res)
   	{
    	...
    	foreach ($res as $k => $v) {
    		...
    		$data['customer_pwd'] = $v['customerpassword'];
